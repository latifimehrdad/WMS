...
//    public static String Host = "http://185.159.87.205:70";
    ...
    public static String Host = "http://samtam.demo.ngraapp.ir";
...
//    public static String client_secret_value = "n5r+sej/lFv7xVhM9F7+kOG9yI64d/JIkGzl0NvgwMM=";
    public static String client_secret_value = "clientSecret==NGRA==community==Apps==8e08620b45cc4074b28a87fc0bab1ccc";
